...
function Input({ label, placeholder, type, error, ...other }: InputProps, ref: any) {
    ...
    return (
        <div className="w-full mb-3">
            ...
            <input ref={ref} {...other} type={type || 'text'} placeholder={placeholder} className={`py-3 text-[13px] font-medium text-slate-600 rounded-[3px] w-full px-3 border  outline-none ${error ? 'border-red-500' : 'border-gray-300'}`} />
